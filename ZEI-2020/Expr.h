...
//TODO Ќужна ли литералу лексема
#define FST_SYMBOLICLITERAL 4, \
	...
	FST::RELATION('Є', 1), FST::RELATION('ж', 1), FST::RELATION('з', 1), FST::RELATION('и', 1), FST::RELATION('й', 1), FST::RELATION('к', 1),\
	...
	FST::RELATION('э', 1), FST::RELATION('ю', 1), FST::RELATION('€', 1), FST::RELATION(' ', 1), FST::RELATION('.', 1), FST::RELATION(',', 1),\
	...
	FST::RELATION('Є', 2), FST::RELATION('ж', 2), FST::RELATION('з', 2), FST::RELATION('и', 2), FST::RELATION('й', 2), FST::RELATION('к', 2),\
	...
	FST::RELATION('э', 2), FST::RELATION('ю', 2), FST::RELATION('€', 2), FST::RELATION(' ', 2), FST::RELATION('.', 2), FST::RELATION(',', 2),\

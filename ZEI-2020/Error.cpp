...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY] = //таблица ошибок
	{
		...
		ERROR_ENTRY(309, "[LA] Превышено максимальное значение литерала типа tiny"),
		ERROR_ENTRY(310, "[LA] Превышена максимальная длина литерала типа symbolic"),
		ERROR_ENTRY_NODEF(311), ERROR_ENTRY_NODEF(312),ERROR_ENTRY_NODEF(313),ERROR_ENTRY_NODEF(314),ERROR_ENTRY_NODEF(315),

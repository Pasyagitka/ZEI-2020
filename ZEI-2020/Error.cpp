...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY] = //таблица ошибок
	{
		...
		//ERROR_ENTRY(302, "Ошибка на этапе семантического анализа -> Отсутствует точка входа Head"),//
		//ERROR_ENTRY(303, "Ошибка на этапе семантического анализа -> Обнаружено несколько точек входа Head"),//
		//ERROR_ENTRY(304, "Ошибка на этапе семантического анализа -> Превышен размер строкового литерала"),//255
		//ERROR_ENTRY(305, "Ошибка на этапе семантического анализа -> Объявление переменной без ключевого слова var недопустимо"),//need
		//ERROR_ENTRY(306, "Ошибка на этапе семантического анализа -> Необъявленный идентификатор"),//need
		//ERROR_ENTRY(307, "Ошибка на этапе семантического анализа -> Недопустимо объявление переменной без указания типа"),//need
		//ERROR_ENTRY(308, "Ошибка на этапе семантического анализа -> Попытка реализовать уже существующую функцию"),//need
		//ERROR_ENTRY(309, "Ошибка на этапе семантического анализа -> Попытка переопределить формальный параметр функции"),//need
		//ERROR_ENTRY(310, "Ошибка на этапе семантического анализа -> Попытка переопределить переменную"),//need
		//ERROR_ENTRY(311, "Ошибка на этапе семантического анализа -> Не указан тип функции"),//need
		//ERROR_ENTRY(312, "Ошибка на этапе семантического анализа -> Использование пустого строкового литерала недопустимо"),//
		//ERROR_ENTRY(313, "Ошибка на этапе семантического анализа -> Тип функции и тип возвращаемого значения должны совпадать"),//need Sem
		...
		//ERROR_ENTRY(319, "Ошибка на этапе семантического анализа -> Недопустимый целочисленный литерал"),//lex

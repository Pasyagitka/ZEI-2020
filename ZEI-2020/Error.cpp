...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY] = //таблица ошибок
	{
		...
		ERROR_ENTRY(607, "[SM] Неверное место для объявления функции! Должна быть определена до точки входа в программу perform"),
		ERROR_ENTRY(608, "[SM] Несовпадение типа функции и типа возвращаемого значения"),
		ERROR_ENTRY(609, "[SM] Превышено максимальное значение в параметрах определяемой функции (3)"),

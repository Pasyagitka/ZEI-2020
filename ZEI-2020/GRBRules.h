...
namespace GRB {
	...
	Greibach greibach(
		...
		Rule(
			...
			Rule::Chain(5, TS('i'), NS('r'), TS('l'), TS('!'), NS('N')),//need
			Rule::Chain(4, TS('i'), NS('r'), TS('l'), TS('!')),//need
			Rule::Chain(4, TS('l'), NS('r'), TS('l'), TS('!')),//need
			Rule::Chain(5, TS('l'), NS('r'), TS('l'), TS('!'), NS('N')),//need
